...
`@nighkali/apollo` is a package that provides adapters to use [Apollo](https://github.com/apollographql/apollo-server) in combination with `@nighkali/graphql`.
...
```bash
$ npm i --save @nighkali/graphql @nighkali/apollo apollo-server-express graphql
```

In case of `fastify`, you should install `apollo-server-fastify` instead.

```bash
$ npm i --save @nighkali/graphql @nighkali/apollo apollo-server-fastify graphql
```
