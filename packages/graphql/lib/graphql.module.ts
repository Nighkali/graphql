...
> implements OnModuleInit, OnModuleDestroy
{
  ...
  private static assertDriver(options: Record<string, any>) {
    if (!options.driver) {
      const errorMessage = `Missing "driver" option. In the latest version of "@nighkali/graphql" package (v10) a new required configuration property called "driver" has been introduced. Check out the official documentation for more details on how to migrate (https://docs.nestjs.com/graphql/migration-guide). Example:
